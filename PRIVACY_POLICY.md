...
MicroMind ("us", "we", or "our") operates the MicroMind mobile application (the "Service").
...
## 2. Use of Data
MicroMind uses the collected data for various purposes:
...
- By email: support@micromind.app
